...
EnableExtraShellUpdate="true"

## DIY 脚本同步地址链接：（默认使用项目中的 DIY 脚本）
#EnableExtraShellURL=""
...
################################## 自动配置助力码（选填） ##################################
## 开启自动配置助力码后，会自动根据已有的账号生成的助力码，自动填写到config.sh中，活动时，账号间自动互相助力，无需人工干预
## 默认关闭，自己手动配置。开启请设置为"true"
AutoHelpme="false"
...
################################## 7. 京东领现金红包兑换京豆开关（选填） ##################################
## 控制京东领现金是否把红包兑换成京豆,false为否,true为是(即：花费2元红包兑换200京豆，一周可换四次)，默认为false
...
# ---------------------------------- export_sharecodes.sh 输 出 复 制 专 区  ----------------------------------
#
#
#
